...
public class ledgerAdapter extends ArrayAdapter {

    private Context context;
    private ArrayList arrayList;

    public ledgerAdapter(@NonNull Context context, int resource, @NonNull ArrayList arrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        sellerLedger.ledgerClass current = (sellerLedger.ledgerClass) arrayList.get(position);
