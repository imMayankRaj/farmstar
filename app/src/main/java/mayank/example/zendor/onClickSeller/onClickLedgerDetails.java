...
public class onClickLedgerDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_click_ledger_details);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLclass.ON_CLICK_BOOKED_CARD_DETAILS, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError) {
                    Toast.makeText(onClickLedgerDetails.this, "Time out. Reload.", Toast.LENGTH_SHORT).show();
                } else
                    showError(error, onClickLedgerDetails.this.getClass().getName(), onClickLedgerDetails.this);
        ...
        builder.setTitle("Call :")
                .setItems(b, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (ActivityCompat.checkSelfPermission(onClickLedgerDetails.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(onClickLedgerDetails.this, new String[]{Manifest.permission.CALL_PHONE},
                                    2);
                            return;
                        }else
